...
ResultSet rs=stmt.executeQuery( "Select *from Contesting_candidate order by C_id");
%>

<center>

<table align='center' cellspacing=1 bordercolor=black cellpadding=10 border='1' cellpadding='0' width='90%' bgcolor="white">
<a href="AdminHome.html">
<img src="69524(1).png" height="7%"  width="5%" align="right">
</a>
<br><br><br>
<center><img src="l.png" height="15%"  width="8%"></center>
<d><center><h2><r>Report : Contesting Candidate Details</r></h2></center></d>
<r><%= (new java.util.Date()).toLocaleString() %></r><hr>
<tr bgcolor="lightblue" >
<th><font size=3 color=black>CID</th>
<th><font size=3 color=black>Voter Name</th>
<th><font size=3 color=black>Contect No.</th>
<th><font size=3 color=black>Course</th>
<th><font size=3 color=black>Email</th>
<th><font size=3 color=black>City</th>
</tr>
